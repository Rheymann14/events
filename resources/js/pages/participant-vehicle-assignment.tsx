...
export default function ParticipantVehicleAssignment({
    events = [],
}: PageProps) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                        Review your assigned vehicle and CHED LO details per
                        event.
                    </p>
                </div>
                ...
                {eventsWithPhase.length === 0 ? (
                    <Card className="border-dashed">
                        <div className="px-5 py-6 text-sm text-slate-500 dark:text-slate-400">
                            No vehicle assignments yet. Join an event to see
